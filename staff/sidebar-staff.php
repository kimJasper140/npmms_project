...
<body>
    ...
    <div class="topbar">
        ...
        <a href="../staff/admin-setting.php" style="margin-left:-45px;">
            <?php
    ...
    <div class="sidebar" id="sidebar">
        <ul>
            <li><a href="../staff/dashboard-staff.php"><i class="fas fa-chart-pie"></i>Dashboard</a></li>
            <li class="dropdown">
                <a href="#" class="dropdown-toggle" id="userDropdownMenuLink">
                    <i class="fas fa-user"></i>User
                </a>
                <ul class="dropdown-menu" id="userDropdownMenu">
                    <li><a href="../staff/user_management.php" class="fas fa-user">Add | View</a></li>
                    <li><a href="../staff/inactive_account.php" class="fas fa-user">Inactive Account</a></li>
                </ul>
            </li>
            <li class="dropdown">
                ...
                <ul class="dropdown-menu" id="applicationsDropdownMenu">
                    ...
                    <li><a href="../staff/approved.php" class="fas fa-users">Approved</a></li>
                    <li><a href="../staff/declined.php" class="fas fa-users">Disapproved</a></li>
                    <li><a href="../staff/cancelled.php" class="fas fa-users">Cancelled</a></li>
                </ul>
            </li>
            <li><a href="../staff/stall_operate.php"><i class="fas fa-store"></i>Stall</a></li>
            <li><a href="../staff/annoucement.php"><i class="fas fa-bullhorn"></i>Announcement</a></li>
            <li><a href="../staff/srp-list.php"><i class="fas fa-tags"></i>SRP</a></li>
            <li>
            <a href="../staff/notification_page.php" id="notification-link" onclick="markNotificationsAsRead()">
        <i class="fas fa-bell"></i>Notification
        <span class="badge" id="notification-badge"><?php echo ($unreadCount > 0) ? $unreadCount : ''; ?></span>
    </a>
            </li>
            <li><a href="../staff/about.php"><i class="fas fa-info-circle"></i>About</a></li>
            <li><a href="../staff/staff-setting.php"><i class="fas fa-cog"></i>Settings</a></li>
            <li>
