...
if (isset($_POST['register'])) {
    ...
    $mail->Body = 'Dear ' . $name . ',<br><br>Your account registration has been successful. Please find the details below:<br><br>' .
        'Name: ' . $name . '<br>' .
        'Email: ' . $email . '<br>' .
        'Address: ' . $address . '<br>' .
        ...
        'Thank you for registering an account at Naujan Public Market.';
