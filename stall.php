...
<body>
    ...
    <div class="container-fluid container">
        ...
        <div class="tab-content container">
            <div class="tab-pane fade show active row" id="available" role="tabpanel" aria-labelledby="available-tab">
                <div class="section-container card">
                    ...
                    function displayStalls($conn, $section, $status) {
                        ...
                        while($row = mysqli_fetch_assoc($stallsResult)) {
                            ...
                            echo '<img class="container row equal-size-img" src="admin/'.htmlspecialchars($row['image']).'" class="stall-image">';
