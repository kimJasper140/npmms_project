            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    <?php foreach ($paymentData as $payment): ?>
                        <tr>
                            <td>
                                <?php echo $payment['months']; ?>
                            </td>
                            <td>
                                <?php echo $payment['salesCount']; ?>
                            </td>
                            <td>
                                <?php echo $payment['paidCount']; ?>
                            </td>
                            <td>
                                <?php echo $payment['unpaidCount']; ?>
                            </td>
                            <td>
                                <?php echo $payment['stallLeased']; ?>
                            </td>
                            <td>
                                <button type="button" class="btn btn-success" style="margin: 2px;">Generate Report</button>
                                <button type="button" class="btn btn-success" style="margin: 2px;" data-toggle="modal"
                                    data-target="#adminLoginModal">Edit Record</button>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
